...
@Component({
  ...
  <div class="container">
      ...
      <div class="videoWrapper videoWrapper169 js-videoWrapper" #jsVideoWrapper>
          <a   class="videoPoster js-videoPoster" style="background-position:center;" [ngStyle]="{ 'background-image': 'url(' + inputData.img + ')'}">Play video</a>
      </div>
  ...
  styles: [
    `
      ...
      .card-bb .videoPoster:hover:before,
      .videoPoster:focus:before {
        border-color: #f00;
      }
      .card-bb .videoPoster:hover:after,
